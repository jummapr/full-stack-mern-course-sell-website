...
class otherController {
  contact = catchAsyncErrorHandler(async (req, res, next) => {
    ...
    const subject = "Contact from JummaCourse";
  ...
  courseRequest = catchAsyncErrorHandler(async (req, res, next) => {
    ...
    const subject = "Request for A course on jummaCourse";
  ...
  //! Get The DashBoard States
  getDashboardState = catchAsyncErrorHandler(async (req, res, next) => {
